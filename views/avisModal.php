  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
            <form class="contact100-form validate-form" role="form" method="put">
      ...
      <div class="modal-footer">
        ...
        <button type="button" id="valider" class="btn btn-success" data-dismiss="modal" onclick="addAvis(<?php echo $avisId;?>)">Valider</button>
      </div>
    </div>
  </div>
</div>